...
```{r figure1, fig.cap="Fastq quality scores for a sample read file", out.width = "400px",echo=FALSE}
...
<p>
![Comparison of observed and fitted error rates from the DADA2 iterative sequence inference algorithm](figure/figure2.png)
