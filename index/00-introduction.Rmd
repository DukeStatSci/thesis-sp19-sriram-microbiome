...
1) Better understand the filtration process that goes into the processing, filtration, and cleaning of microbiome sequencing data.

2) Devise effective, interactive visualizations for exploratory data analysis of the dynamics of microbiome compositions.

3) Apply statistical methodology to identify potential associations between factors in recovery from leukemia and the gut microbiome.