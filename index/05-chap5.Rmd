...
Due to the fact that we had performed multiple tests, we applied a Bonferroni correction to our 22 nodes, requiring a p-value smaller than $.05/22 = 2.27 * 10^{-3}.$ We settled on Bonferroni correction over other approaches to handling the multiple testing process due to how few of our nodes yielded successful regressions. With a success rate of roughly 0.2%, Bonferroni correction helps us feel more certain that the variables we identify are significant. In the future, we may choose to consider other forms of False Discovery Rate-controlling procedures, which would be less severe but still sufficiently accurate.
